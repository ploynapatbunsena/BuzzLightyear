<template>
  <div class="container">
    <div id="map"></div>
    <!-- compass in map -->
    <img :src="require('@/assets/compass_test.svg')" alt="" class="compass" />
    <CompassView :bearing="currentBearing" />
  </div>
</template>
...
// import CompassView from './Compass-view.vue';
...
export default {
  ...
  setup() {
    ...
    onMounted(() => {
      ...
      // Add markers
      const markers = [
        { position: [13.122581, 100.816189], name: 'Ketsarin 1' },
      ];
